...
public class MultiplePrograms extends Window implements ApplicationLogic {
	...
	String vertexShaderFileLoc = "res/shaders/drawing1.vert";
	String fragmentShaderFileLoc = "res/shaders/drawing1.frag";
	...
	private void initBuffers() {
		...
		modelPos = new Vector3f(-1.0f, -2.0f, -3.2f);
