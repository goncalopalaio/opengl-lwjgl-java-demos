...
public class SevenToonShaders extends Window implements ApplicationLogic {
	...
	/*Strings*/
	String objFileName = "res/models/human_low.obj";
	String texFileName = "res/texture_training_grounds.png";
	String vertexShaderFileLoc = "res/shaders/toon/vertex1.glsl";
	String fragmentShaderFileLoc = "res/shaders/toon/fragment1.glsl";

	public SevenToonShaders() {
